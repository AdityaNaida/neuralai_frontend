...
export default function Hero() {
  return (
    <div className=" py-20 md:min-h-[calc(100vh-80px)] h-auto  w-full flex items-center justify-center flex-col gap-3 text-center">
      ...
      <div className="relative w-full mt-4">
        ...
        >
          <div className="p-1.5 relative ">
            ...
            <p className="text-center font-semibold">Neural AI</p>
          </div>
          <img
            src="/neural_dashboard.webp"
            alt="dashboard"
            className="h-auto max-w-96 md:max-w-4xl"
