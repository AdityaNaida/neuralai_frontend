  ...
  return (
    <div className=" py-20 md:min-h-[calc(100vh-80px)] overflow-x-hidden h-auto  w-full flex items-center justify-center flex-col gap-3 text-center">
      ...
      <div className="relative w-full mt-4 px-3">
        <div className="h-4/5 w-1/2 bottom-10 left-0 bg-linear-to-r/increasing from-blue-200 to-green-400 blur-2xl absolute"></div>
        <div className="h-4/5 w-1/2 bottom-10 right-0 bg-linear-to-r/increasing  from-purple-200 to-purple-400 blur-2xl absolute"></div>
        <div
